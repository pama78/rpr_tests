...
-------------------------------------------------
  ...
  -- run1 (4320 evts, 2s, cmp 1m10s)
  Insert into PRICELIST (ID, NAME, TYPE, V_Z1_O)   Values (109, 'Balicek B4', 'A', 2.2); 
  -- run2 (8640evt, cmp 3m30)
  Insert into PRICELIST (ID, NAME, TYPE, V_Z1_O)   Values (110, 'Balicek B5', 'A', 3.3);  
  -- run 3 (17280evt, cmp 6 min)
  Insert into PRICELIST (ID, NAME, TYPE, V_Z3_O)   Values (111, 'Balicek B6', 'A', 24.5);  
  -- rum4 ( 32k, cmp10min)
  Insert into PRICELIST (ID, NAME, TYPE, V_Z3_O)   Values (112, 'Balicek B7', 'A', 22.5);  
--run5 (64k, 22min)?? 
  Insert into PRICELIST (ID, NAME, TYPE, SMS, DATA)        Values (113, 'Balicek B8', 'A', 0.5, 165);  
--run6 (34min, diffs 9224, tot 130k)
 Insert into PRICELIST (ID, NAME, TYPE, V_Z3_O)   Values (114, 'Balicek B9', 'A', 22.2);
 commit;
...
-------------------------------------------------
--Step 2: create customers according to pricelist --2304x
-------------------------------------------------
set serveroutput on ;
DECLARE    
   res number;    
...
-------------------------------------------------
--Step 3: do rating --rate 138k events, 4min
-------------------------------------------------
DECLARE    
   res number;  
   k_date VARCHAR2(30);   
